...
Partial Public Class LauncherButton : Inherits UserControl
    ...
    Public Shared ReadOnly TextProperty As AvaloniaProperty(Of String) =
            AvaloniaProperty.Register(Of LauncherButton, String)(NameOf(Text))
    ...
    Public Shared ReadOnly BackColorProperty As AvaloniaProperty(Of Color) =
        AvaloniaProperty.Register(Of LauncherButton, Color)(NameOf(BackColor))
    ...
    Public Shared ReadOnly IsButtonDisabledProperty As AvaloniaProperty(Of Boolean) =
        AvaloniaProperty.Register(Of LauncherButton, Boolean)(NameOf(IsButtonDisabled))
    ...
    Public Shared ReadOnly IsButtonCorneredProperty As AvaloniaProperty(Of Boolean) =
        AvaloniaProperty.Register(Of LauncherButton, Boolean)(NameOf(IsButtonCornered))
