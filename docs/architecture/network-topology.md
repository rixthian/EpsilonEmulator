...
For the local multiprocess topology derived from reference stacks, see [local-runtime.md](/Users/yasminluengo/Documents/Playground/EpsilonEmulator/docs/architecture/local-runtime.md).
