...
public sealed class HotelReadService : IHotelReadService
{
    ...
    private readonly IPublicRoomPackageRepository _publicRoomPackages;
    ...
    public HotelReadService(
        ...
        IPublicRoomPackageRepository publicRoomPackages)
    {
        ...
        _publicRoomPackages = publicRoomPackages;
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        PublicRoomPackageDefinition? assetPackage =
            await _publicRoomPackages.GetByKeyAsync(entry.AssetPackageKey, cancellationToken);
