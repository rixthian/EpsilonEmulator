...
internal static class InMemoryHotelSeedBuilder
{
    public static InMemoryHotelStore Build()
    {
        ...
        GroupId buildersGroupId = new(1);
        GroupId publicEventsGroupId = new(2);

        store.Groups[buildersGroupId] = new HotelGroup(
            buildersGroupId,
            characterId,
            "Room Builders",
            "Builders and decorators working on public and private spaces.",
            "GRPBUILD",
            new RoomId(20),
            GroupJoinMode.Open,
            DateTime.UtcNow.AddDays(-30));
        store.Groups[publicEventsGroupId] = new HotelGroup(
            publicEventsGroupId,
            moderatorCharacterId,
            "Public Events",
            "Hosts, moderators, and event regulars.",
            "GRPEVENT",
            new RoomId(10),
            GroupJoinMode.Locked,
            DateTime.UtcNow.AddDays(-12));

        store.GroupMemberships[buildersGroupId] =
        [
            new GroupMembership(buildersGroupId, characterId, GroupMemberRole.Owner, DateTime.UtcNow.AddDays(-30), true),
            new GroupMembership(buildersGroupId, roomGuardianCharacterId, GroupMemberRole.Admin, DateTime.UtcNow.AddDays(-28), false),
            new GroupMembership(buildersGroupId, playerCharacterId, GroupMemberRole.Member, DateTime.UtcNow.AddDays(-10), false)
        ];

        store.GroupMemberships[publicEventsGroupId] =
        [
            new GroupMembership(publicEventsGroupId, moderatorCharacterId, GroupMemberRole.Owner, DateTime.UtcNow.AddDays(-12), false),
            new GroupMembership(publicEventsGroupId, managerCharacterId, GroupMemberRole.Admin, DateTime.UtcNow.AddDays(-10), false),
            new GroupMembership(publicEventsGroupId, playerCharacterId, GroupMemberRole.Pending, DateTime.UtcNow.AddDays(-1), false)
        ];
        ...
        [
            ...
            new ChatCommandDefinition("ha", "Queue a hotel-wide alert.", ChatCommandScope.HotelModerator, false, ["hotelalert"], StaffCapabilityKeys.HotelAlert),
        ...
        store.Rooms[new RoomId(20)] = new RoomDefinition(
            RoomId: new RoomId(20),
            RoomKind: RoomKind.Private,
            OwnerCharacterId: characterId,
            Name: "Epsilon Workshop",
            Description: "Private build room linked to the Room Builders group.",
            CategoryId: 4,
            LayoutCode: "newbie_lobby",
            Settings: new RoomSettings(RoomAccessMode.Open, null, 25, true, false, false, false),
            Tags: ["private", "builders", "group"]);
        ...
        [
            new HotelBotDefinition(
                ...
                GreetingMessage: "Welcome to the hotel.",
                IdleMessage: "Need directions? Ask me about rooms, games, or help.",
                SpawnOffsetX: -2,
                SpawnOffsetY: 0,
                BodyRotation: 2,
                IsEnabled: true,
                AllowedTopics: ["welcome", "navigator", "games", "support"],
                Waypoints:
                [
                    new BotWaypoint(12, 7, 6),
                    new BotWaypoint(13, 7, 6)
                ],
                Replies:
                [
                    new BotReplyDefinition(
                        "welcome",
                        ["hello", "hi", "welcome", "help"],
                        "Welcome to the hotel. Ask me about rooms, games, or support.",
                        null,
                        null),
                    new BotReplyDefinition(
                        "games",
                        ["battleball", "snowstorm", "wobble", "game"],
                        "The game halls are open. BattleBall, SnowStorm, and Wobble Squabble are all available.",
                        null,
                        null)
                ]),
            new HotelBotDefinition(
                ...
                LanguageCode: "en",
                DialogueMode: BotDialogueMode.Scripted,
                GreetingMessage: "Cold drinks and ice cream served all day.",
                IdleMessage: "Ask for an ice cream, juice, or soda.",
                SpawnOffsetX: -3,
                SpawnOffsetY: 1,
                BodyRotation: 2,
                IsEnabled: true,
                AllowedTopics: ["lido", "drink", "icecream", "juice", "soda"],
                Waypoints:
                [
                    new BotWaypoint(11, 8, 8)
                ],
                Replies:
                [
                    new BotReplyDefinition(
                        ...
                        "One ice cream coming right up.",
                        17,
                        "Ice Cream"),
                    new BotReplyDefinition(
                        "juice",
                        ["juice", "orange juice"],
                        "Fresh juice for the deck.",
                        18,
                        "Orange Juice"),
                    new BotReplyDefinition(
                        "soda",
                        ["soda", "drink", "cola"],
                        "Here is your cold drink.",
                        19,
                        "Cold Soda")
                ]),
            new HotelBotDefinition(
                ...
                LanguageCode: "en",
                DialogueMode: BotDialogueMode.Scripted,
                GreetingMessage: "Match officials are on the floor.",
                IdleMessage: "Ask about teams, scoring, or match rules.",
                SpawnOffsetX: -2,
                SpawnOffsetY: -1,
                BodyRotation: 2,
                IsEnabled: true,
                AllowedTopics: ["battleball", "score", "teams", "rules"],
                Waypoints:
                [
                    new BotWaypoint(13, 6, 10)
                ],
                Replies:
                [
                    new BotReplyDefinition(
                        "rules",
                        ["rules", "how", "play"],
                        "BattleBall is team control. Stay moving and capture floor pressure quickly.",
                        null,
                        null),
                    new BotReplyDefinition(
                        "score",
                        ["score", "points", "team"],
                        "Score tracking is live. Ask staff to prepare or start the next round.",
                        null,
                        null)
                ]),
            new HotelBotDefinition(
                ...
                LanguageCode: "en",
                DialogueMode: BotDialogueMode.Scripted,
                GreetingMessage: "Step into the wobble ring.",
                IdleMessage: "Ask for rules or a pre-match drink.",
                SpawnOffsetX: -2,
                SpawnOffsetY: 1,
                BodyRotation: 4,
                IsEnabled: true,
                AllowedTopics: ["wobble", "drink", "rules", "duel"],
                Waypoints:
                [
                    new BotWaypoint(12, 8, 8)
                ],
                Replies:
                [
                    new BotReplyDefinition(
                        "rules",
                        ["rules", "duel", "wobble"],
                        "Stay inside the ring and outlast your opponent. Timing matters more than force.",
                        null,
                        null),
                    new BotReplyDefinition(
                        "drink",
                        ["drink", "juice", "soda"],
                        "Take a quick drink before the next duel.",
                        18,
                        "Orange Juice")
                ]),
            new HotelBotDefinition(
                ...
                LanguageCode: "en",
                DialogueMode: BotDialogueMode.Scripted,
                GreetingMessage: "The debate floor is open.",
                IdleMessage: "Public questions and event scripts run through this stage.",
                SpawnOffsetX: -1,
                SpawnOffsetY: 1,
                BodyRotation: 4,
                IsEnabled: true,
                AllowedTopics: ["events", "polls", "public_discussion"],
                Waypoints:
                [
                    new BotWaypoint(14, 8, 8)
                ],
                Replies:
                [
                    new BotReplyDefinition(
                        "events",
                        ["event", "debate", "topic"],
                        "This stage is configured for public events, polls, and guided discussion.",
                        null,
                        null)
                ])
        ]);
        ...
        [
            new RoomChatMessage(1, homeRoomId, characterId.Value, "epsilon", "Welcome to the room runtime slice.", RoomChatMessageKind.System, null, null, DateTime.UtcNow.AddMinutes(-5))
        ];
