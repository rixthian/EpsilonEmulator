...
public static class DependencyInjection
{
    public static IServiceCollection AddPersistenceRuntime(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<IGroupRepository>(provider =>
            ResolveProvider(
                provider,
        ...
        services.AddSingleton<IRoomBotDefinitionRepository>(provider =>
            ResolveProvider(
                provider,
                inMemory: sp => sp.GetRequiredService<InMemoryRoomBotDefinitionRepository>(),
                postgres: sp => throw new NotSupportedException("Document-backed room-bot repository is not wired yet.")));
        ...
        services.AddSingleton<InMemoryRoomBotDefinitionRepository>();
